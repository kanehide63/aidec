(() => {
  ...
  const type = {ai360:'AI企業診断360について',web:'Web制作について',support:'継続支援について',operations:'業務改善・システム導入支援について',referral:'ご紹介特典について',other:'その他'}[new URLSearchParams(location.search).get('type')];
